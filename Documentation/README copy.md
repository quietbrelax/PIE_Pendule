...
Ce dépôt contient l'essentiel des ressources (articles et thèses, codes) jugées pertinentes par l'équipe 25-26.
Il permet de simuler, stabiliser et explorer le contrôle d’un simple ou double pendule monté sur un chariot en translation linéaire, sur sa simulation.
Il permet aussi un contrôle du pendule, mais il est conseillé de se pencher bien sur la hardware rapidement car sur la fin des résultats pas tout à fait concluants ont été obtenus.
